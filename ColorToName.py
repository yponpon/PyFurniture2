...
def getColorName(hex):
    color = hexToRGB(hex)
    return ColorNames.findNearestImageMagickColorName(color)

def get_dictionary(dic):
    new_dict = dict()
    for k,v in dic.items(): #loop key,item in dic
        colorName = getColorName(k)
        new_dict[colorName] = v
    return new_dict
...
#     color = hexToRGB(hex)
#     print(color)
#     print (ColorNames.findNearestImageMagickColorName(color)) #用此方法
